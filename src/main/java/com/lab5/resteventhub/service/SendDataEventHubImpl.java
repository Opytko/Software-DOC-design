...
public class SendDataEventHubImpl implements SendDataService {
    ...
    public void sendAndLog(String url) throws IOException, EventHubException {
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                ...
                .setEventHubName("pytkoevent")//hub name
                /*Connection string–primary key*/
                .setSasKeyName("Endpoint=sb://pytkohub.servicebus.windows.net/;SharedAccessKeyName=pytkopolicy;SharedAccessKey=CyXduQcJuGiquA6POspzXD09JmA6kbzsHlTkL15845g=;EntityPath=pytkoevent")
                /*Primary key*/
                .setSasKey("CyXduQcJuGiquA6POspzXD09JmA6kbzsHlTkL15845g=");
